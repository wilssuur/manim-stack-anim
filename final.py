...
HIGHLIGHT_COLOR = ORANGE          # активная инструкция
ACTIVE_BLOCK_COLOR = YELLOW       # блок инструкций под C++ строку
ACTIVE_BRACE_COLOR = YELLOW       # подсветка { и }

# СКОРОСТЬ АНИМАЦИИ
# 1.0 = текущая скорость; 2.0 = в 2 раза быстрее (все run_time / SPEED_*)
SPEED_MISC = 1.0   # вступление, общие переходы
SPEED_MAIN = 1.0
SPEED_ADD  = 1.0
SPEED_F2   = 1.0
SPEED_F3   = 1.0
...
class StackDemo(Scene):
    ...
    def _hl_cpp_text(self, needle: str, occurrence: int = 1, color=HIGHLIGHT_COLOR):
    ...
    def _prologue(self, func_name, local_bytes=0, cpp_open_occ: int | None = None):
        ...
        self.play(*[FadeIn(m) for m in [cpp_brace, asm_block] if m], run_time=0.18)
    ...
    def _epilogue_leave_ret(self, func_name, cpp_close_occ: int | None = None):

        cpp_brace = self._hl_cpp_text("} // эпилог", occurrence=cpp_close_occ, color=ACTIVE_BRACE_COLOR) if cpp_close_occ else None
        asm_block = self._hl_asm_block("mov     esp, ebp", "ret", color=ACTIVE_BLOCK_COLOR)
        self.play(*[FadeIn(m) for m in [cpp_brace, asm_block] if m], run_time=0.18)
...
main:
        ...
        self.play(FadeIn(cpp_main_call), FadeIn(asm_block_main_call), run_time=0.20)
        ...
        self.play(FadeIn(cpp_c), FadeIn(asm_block_c), run_time=0.18)
        ...
        self.play(FadeIn(cpp_k), FadeIn(asm_block_k), run_time=0.18)
        ...
        self.play(FadeIn(cpp_t), FadeIn(asm_block_t), run_time=0.18)
        ...
        self.play(FadeIn(cpp_r), FadeIn(asm_block_r), run_time=0.18)
        ...
        self.play(FadeIn(cpp_u), FadeIn(asm_block_u), run_time=0.18)
        ...
        self.play(FadeIn(cpp_ret_u), FadeIn(asm_block_ret_u), run_time=0.18)
        ...
        self.play(FadeIn(cpp_ret_r2), FadeIn(asm_block_ret_r2), run_time=0.18)
        ...
        self.play(FadeIn(cpp_ret_k), FadeIn(asm_block_ret_k), run_time=0.18)
        ...
        self.play(FadeIn(cpp_ret0), FadeIn(asm_block_ret0), run_time=0.18)
        ...
        self._epilogue_leave_ret("main", cpp_close_occ=None)
